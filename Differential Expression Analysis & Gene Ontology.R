...
hist(all_genes_results$pvalue, col="lightblue", main = "Unadjusted p-value distribution")
...
diff_expressed_genes_annotated <- biomartr::biomart(genes = diff_expressed_genes$gene,
                                                     mart = "plants_mart",
                                                     dataset = "athaliana_eg_gene",
                                                     attributes = attributes_to_retrieve,
                                                     filters = "ensembl_gene_id" )
...
ora_analysis_bp <- enrichGO(gene = diff_expressed_genes_annotated$entrezgene_id, 
